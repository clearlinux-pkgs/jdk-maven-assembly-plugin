...
License  : Apache-2.0
Requires: jdk-maven-assembly-plugin-data
...
BuildRequires : six
BuildRequires : xmvn
Patch1: 0001-Port-to-Maven-Filtering-3.0.0.patch
Patch2: 0002-Port-to-Maven-Shared-IO-3.0.0.patch

%description
MASSEMBLY-111

%package data
Summary: data components for the jdk-maven-assembly-plugin package.
Group: Data

%description data
data components for the jdk-maven-assembly-plugin package.


%prep
%setup -q -n maven-assembly-plugin-2.6
%patch1 -p1
%patch2 -p1

python3 /usr/share/java-utils/pom_editor.py pom_xpath_set      pom:mavenVersion 3.3.3
...
%install
xmvn-install  -R .xmvn-reactor -n maven-assembly-plugin -d %{buildroot}
